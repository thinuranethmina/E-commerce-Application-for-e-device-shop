...
@section('content')
    <div class="row">
                ...
                <div class="col-xl-4">
                    <div class="card bg-pink">
                        <div class="card-body">
                            ...
                            <p class="card-text text-white">{{ $categories->count() }}</p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4">
                    <div class="card bg-orange">
                        <div class="card-body">
                            <h5 class="card-title text-white">Active Categories</h5>
                            <p class="card-text text-white">{{ $categories->where('status', 'Active')->count() }}</p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4">
                    <div class="card bg-purple">
                        <div class="card-body">
                            <h5 class="card-title text-white">Inactive Categories</h5>
                            <p class="card-text text-white">{{ $categories->where('status', 'Inctive')->count() }}</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-xl-12 d-flex justify-content-end mb-4">
            <div>
                <button onclick="loadModal('category','create')" class="btn btn-primary" type="button">
                                            ...
                                            @forelse ($items as $index => $item)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="actions">
                                                            <button
                                                                onclick="loadModal('category','edit',{{ $item->id }})"
                                                                class="edit-btn action-btn">
                                                                <i class="fi fi-rr-edit"></i>
                                                            </button>
                                                            <button onclick="deleteItem({{ $item->id }},'category')"
