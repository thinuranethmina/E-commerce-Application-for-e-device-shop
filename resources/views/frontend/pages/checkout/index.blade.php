...
@section('content')
    <section class="checkout-section">
        <div class="container-xxl">
            <form action="{{ route('checkout.store') }}" id="checkoutForm" enctype="multipart/form-data" method="post">
                @csrf
                <div class="row mx-auto align-items-start">

                    <div class="col-12 col-lg-6 col-xl-7 mt-3 mt-lg-0">
                        <h1 class="section-title mt-4 mt-lg-0">Checkout</h1>
                        ...
                        <div class="order-summery-card">
                            <div class="px-1 px-md-3 px-lg-4">
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    <span>Subtotal</span>
                                    <span class="sub-total">Rs {{ number_format($cartTotal, 2) }}</span>
                                </div>

                                <?php $delivery_fee = count($cartProducts) > 0 ? $settings['payment.delivery_fee'] : '0'; ?>
                            ...
                            <div class="total-card mt-4">
                                ...
                                <span class="total-price">Rs
                                    {{ number_format($cartTotal + $delivery_fee, 2) }}</span>
                            </div>
